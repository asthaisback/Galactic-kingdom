                ...
                <div style={{ backgroundColor: '#041125' }} className=" rounded-lg"> {/* Inner content with gray background */}
                    ...
                    <div className="flex flex-col lg:flex-row h-auto lg:h-16 justify-between rounded-lg items-center px-4 py-4 lg:py-0 relative navbar">
                        ...
                        <div className="absolute top-4 left-4 lg:relative lg:top-0 lg:left-0 lg:flex lg:items-start lg:flex-col">
                            {/* 3-dots image */}
                            <img src="../src/assets/3dots.png" className="h-2" alt="dots" />
                        ...
                        <div className="flex flex-row justify-between lg:justify-end gap-2 mt-2 lg:mt-0 w-full lg:w-auto">
                            <div className="flex justify-start">
                                <img className="h-7" src="../src/assets/home.png" alt="home" />
                            </div>
                            <div className="flex justify-center gap-4 items-center">
                                {/* Previous Button with Circle */}
                                <div className="relative">
                                    <img className="h-4 z-10 absolute inset-0 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" src="../src/assets/prev.png" alt="previous" />
                                    <img className="h-6 w-6" src="../src/assets/Circle.png" alt="circle-prev" />
                                </div>
        
                                {/* Next Button with Circle */}
                                <div className="relative">
                                    <img className="h-4 z-10 absolute inset-0 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" src="../src/assets/next.png" alt="next" />
                                    <img className="h-6 w-6" src="../src/assets/Circle.png" alt="circle-next" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row p-6 lg:p-28 justify-between rounded-lg gap-8">
                        ...
                        <div className="flex justify-center lg:justify-end lg:w-1/2">
                            <img className="h-48 lg:h-96" src="../src/assets/card.png" alt="card" />
                        </div>
                    </div>
